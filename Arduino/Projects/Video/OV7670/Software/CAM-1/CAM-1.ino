/*
 *   Modified to give ASCII art image of each frame.
 *
 *   Press ENTER to take another snap.
 *
 *   See: http://paulbourke.net/dataformats/asciiart/
 *
 *
 ...
 *        " .:-=+*#%@"
 *
 *   An obvious problem is the variation in apparent density between some 
 *   typefaces. Another issue is the stretching in height due to the 
 *   rectangular aspect ratio of characters. When creating such images by 
 *   software by sampling "real" images it is common to sample half as 
 *   often in the vertical direction. Of course if the aspect ratio of the 
 *   font being used is known then exact vertical and horizontal sampling can 
 *   occur. 
 */
...
/*
 * The matrix defines how the colors are generated, must be
...
#define   AWBCTR7             0x59  /* AWB Control 7 */
#define   AWBCTR8             0x5a  /* AWB Control 8 */
#define   AWBCTR9             0x5b  /* AWB Control 9 */
#define   AWBCTR10            0x5c  /* AWB Control 10 */
#define   AWBCTR11            0x5d  /* AWB Control 11 */
#define   AWBCTR12            0x5e  /* AWB Control 12 */
...
//                                                                    Functions
//-----------------------------------------------------------------------------
void      CaptureImage   (uint16_t wg, uint16_t hg) ;
void      camInit        (void) ;
void      ImageDump      (uint16_t wg, uint16_t hg) ;
